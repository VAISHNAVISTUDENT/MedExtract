...
def file1_app(window, file_path, pages, V):
    global i
    i = V
    ...
    resized_image.save(r"C:\Users\HP\Desktop\coding_files\python_general\python_project_final\frame\image_1.png")

    def next_button():
        global count
        count += 1
        gui_data.file1_app(window, file_path, pages, count)
    ...
    button_image_3 = PhotoImage(file=r"C:\Users\HP\Desktop\coding_files\python_general\python_project_final\frame\image_1.png")
    button_3 = Button(
    ...
    button_image_1 = PhotoImage(file=r"C:\Users\HP\Desktop\coding_files\python_general\python_project_final\build2\assets\frame0\button_1.png")
    button_1 = Button(
    ...
    button_image_2 = PhotoImage(file=r"C:\Users\HP\Desktop\coding_files\python_general\python_project_final\build2\assets\frame0\button_2.png")
    button_2 = Button(
    ...
    entry_image_1 = PhotoImage(file=r"C:\Users\HP\Desktop\coding_files\python_general\python_project_final\build2\assets\frame0\entry_1.png")
    ...
    entry_image_2 = PhotoImage(file=r"C:\Users\HP\Desktop\coding_files\python_general\python_project_final\build2\assets\frame0\entry_2.png")
    ...
    entry_image_3 = PhotoImage(file=r"C:\Users\HP\Desktop\coding_files\python_general\python_project_final\build2\assets\frame0\entry_3.png")
